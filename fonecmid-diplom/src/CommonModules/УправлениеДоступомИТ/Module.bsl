...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Идентификатор = "6f27c3a8-ce43-4083-ac1b-6b6533e8d3a8";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ПодсистемаВКМ_ОбслуживаниеКлиентов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЧтениеФизическихЛиц"); 
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля); 
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "d3a3ba0d-c481-40aa-803f-22535fd10b8a";
	...
	ОписаниеПрофиля.Идентификатор = "0a10b131-a0c5-4bb3-acbe-599fc15a7282";
	...
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеКонтрагентов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЧтениеОбслуживанийКлиентов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОбработкиМассовогоСозданияРТУ");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ПросмотрАнализаВыставленныхАктов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ПодсистемаВКМ_ОбслуживаниеКлиентов"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЧтениеФизическихЛиц");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИзменениеКонстантАбонентскогоОбслуживания");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеДокументовПродажи");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	ОписаниеПрофиля.Идентификатор = "a5bbdda8-b00f-4015-a00a-42ab17545334";
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеФизическихЛиц");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеРасчетаЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеГрафиковРаботы");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеУсловийОплатыСотрудников"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеГрафикаОтпусков");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОбработкиЗаполненияГрафикаРаботы");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ПодсистемаВКМ_РасчетыССотрудниками");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	//--
